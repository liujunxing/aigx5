...
export class SimpleAI {
  ...
  public async create(messages: OpenAI.ChatCompletionMessageParam[], opts: SimpleOption = {}) {
  ...
  public async createStream(messages: OpenAI.ChatCompletionMessageParam[], opts: SimpleOption = {}) {
    return this._openai.chat.completions.create({
      model: this._model,
      messages,
      stream: true,
